...
function Credits() {
    return (
        (<>
            ...
            <h2 style={{margin:"0 auto", width:"70%", color:"rgb(189, 189, 189)"}}>
            This page is dedicated to the people who provided the free assets for these websites, as well as the creators of this website themselves!
            <br></br>We pride ourselves in giving credit to those who deserve it (and also being legal!) 
            </h2>
            ...
            <h3>
                Credit for Free Assets Used: 
            </h3>
            <p>
                Software by Alzam from <a href="https://thenounproject.com/browse/icons/term/software/" target="_blank" title="Software Icons">Noun Project</a> (CC BY 3.0) <br/>
